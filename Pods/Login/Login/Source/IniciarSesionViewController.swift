...
@available(iOS 13.0, *)
public class IniciarSesionViewController: UIViewController {
    ...
    public func empezarActivityIndicator() {
    ...
    public func terminarActivityIndicator() {
    ...
    public func configuracionVista(){
    ...
    public func inicioSesion(correo: String, contraseña: String){
    ...
    @objc public func registrarButtonTapped(sender: UIButton!){
